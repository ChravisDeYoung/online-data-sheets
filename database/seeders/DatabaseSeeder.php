...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Field::insert([
            ...
            ['page_id' => $safetyDataSheet->id, 'name' => 'Melting Point (°C)', 'type' => Field::TYPE_NUMBER, 'subsection' => 'Physical & Chemical Properties', 'subsection_sort_order' => 3, 'sort_order' => 4, 'minimum' => 12.20, 'maximum' => 19.20, 'select_options' => null, 'required_columns' => '1', 'created_at' => now(), 'updated_at' => now()],
