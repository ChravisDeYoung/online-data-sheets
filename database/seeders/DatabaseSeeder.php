...
//
//        Role::insert([
//            ['name' => 'admin', 'description' => 'Administrator - Can access all features'],
//            ['name' => $safetyDataSheet->slug, 'description' => "$safetyDataSheet->name - Can access and edit data"],
//            ['name' => $processSheet->slug, 'description' => "$processSheet->name - Can access and edit data"],
//            ['name' => $equipmentSheet->slug, 'description' => "$safetyDataSheet->name - Can access and edit data"],
//        ]);
//
//        $user
    }
